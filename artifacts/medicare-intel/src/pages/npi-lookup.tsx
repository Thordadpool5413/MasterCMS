      ...
      {!loading && result && (
        <>
          <p className="mb-3 text-sm text-[hsl(var(--muted-foreground))]">
            {(result.result_count ?? 0).toLocaleString('en-US')} total results — showing {providers.length}. Click a row for details.
          </p>
                    ...
                    <>
                      ...
                      {isExpanded && (
                        <TableRow key={`${p.number}-expanded`}>
                          <TableCell colSpan={14} className="bg-[hsl(var(--muted)/0.3)] p-4">
